<script lang="ts">
	...
	const images = [slice.primary.image_1, slice.primary.image_2, slice.primary.image_3];
...
>
	...
	>
		...
		<div
			class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 pt-8 pointer-events-auto"
		>
